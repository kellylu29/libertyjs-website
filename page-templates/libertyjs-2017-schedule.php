...
<h1 class="ljs2018-template-info__heading">
	<?php echo esc_html( get_the_title() ); ?>
</h1>

<div class="ljs2018-template-schedule__container" id="ljs2018-template-schedule__day1">
	<div class="ljs2018-template-schedule__container-day">
		<div class="ljs2018-template-schedule__date">
			<p>NOV 16TH</p>
			<p><span class="ljs2018-template-schedule__date-active">DAY 1</span> / <a href="#ljs2018-template-schedule__day2">DAY 2</a></p>
		</div>
		<div class="ljs2018-template-schedule__speakers">
			<div class="ljs2018-template-schedule__divider">
				<div>Registration 08:30 am</div>
			</div>
			<div class="ljs2018-template-schedule__speaker ljs2018-template-schedule__speaker-three">
				<div class="ljs2018-template-schedule__speaker-body">
					<div class="ljs2018-template-schedule__speaker-info">
						<span class="ljs2018-template-schedule__time">08:30 - 09:20</span>
						<span class="ljs2018-template-schedule__name">Breakfast and Registration</span>
						<span class="ljs2018-template-schedule__title"></span>
					</div>
				</div>
			</div>
			<div class="ljs2018-template-schedule__speaker ljs2018-template-schedule__speaker-three">
				<div class="ljs2018-template-schedule__speaker-body">
					<div class="ljs2018-template-schedule__speaker-info">
						<span class="ljs2018-template-schedule__time">09:20 - 09:30</span>
						<span class="ljs2018-template-schedule__name">Opening Remarks</span>
						<span class="ljs2018-template-schedule__title"></span>
					</div>
				</div>
			</div>
			<div class="ljs2018-template-schedule__speaker ljs2018-template-schedule__speaker-three">
				<div class="ljs2018-template-schedule__speaker-body">
					<img
						...
						alt="Ernie Turner">
					<div class="ljs2018-template-schedule__speaker-info">
						<span class="ljs2018-template-schedule__time">09:30 - 10:10</span>
						<span class="ljs2018-template-schedule__name">Ernie Turner</span>
						<span class="ljs2018-template-schedule__title">Dodging Web Crypto API Landmines</span>
					</div>
					<div class="ljs2018-template-schedule__more-toggle">
						<i
							class="fa fa-chevron-up ljs2018-template-schedule__more-toggle-icon"
							aria-hidden="true"></i>
					</div>
				</div>
				<div class="ljs2018-template-schedule__speaker-more">
			...
			<div class="ljs2018-template-schedule__speaker ljs2018-template-schedule__speaker-one">
				<div class="ljs2018-template-schedule__speaker-body">
					<img
					...
					<div class="ljs2018-template-schedule__speaker-info">
						<span class="ljs2018-template-schedule__time">10:25 - 12:00</span>
						<span class="ljs2018-template-schedule__name">Brian Gantick + Austin Starin</span>
						<span class="ljs2018-template-schedule__title">A Vue (app) from the top - Introduction to Vue.js Workshop</span>
					</div>
					<div class="ljs2018-template-schedule__more-toggle">
						<i
							class="fa fa-chevron-up ljs2018-template-schedule__more-toggle-icon"
			...
			<div class="ljs2018-template-schedule__speaker ljs2018-template-schedule__speaker-two">
				<div class="ljs2018-template-schedule__speaker-body">
					<img
						src="https://libertyjs.com/wp-content/uploads/2017/10/sam-jones-e1507126360281.png"
						alt="Sam Jones">
					<div class="ljs2018-template-schedule__speaker-info">
						<span class="ljs2018-template-schedule__time">10:25 - 11:05</span>
						<span class="ljs2018-template-schedule__name">Sam Jones</span>
						<span class="ljs2018-template-schedule__title">JavaScript Is Too Convenient</span>
					</div>
					<div class="ljs2018-template-schedule__more-toggle">
						<i
							class="fa fa-chevron-up ljs2018-template-schedule__more-toggle-icon"
			...
			<div class="ljs2018-template-schedule__speaker ljs2018-template-schedule__speaker-two">
				<div class="ljs2018-template-schedule__speaker-body">
					<img
						...
						alt="Connor Skiro">
					<div class="ljs2018-template-schedule__speaker-info">
						<span class="ljs2018-template-schedule__time">11:20 - 12:00</span>
						<span class="ljs2018-template-schedule__name">Connor Skiro</span>
						<span class="ljs2018-template-schedule__title">Lean Coffee Session</span>
					</div>
					<div class="ljs2018-template-schedule__more-toggle">
						<i
							class="fa fa-chevron-up ljs2018-template-schedule__more-toggle-icon"
			...
			<div class="ljs2018-template-schedule__speaker ljs2018-template-schedule__speaker-one">
				<div class="ljs2018-template-schedule__speaker-body">
					<img
						...
						alt="Matt Morgis">
					<div class="ljs2018-template-schedule__speaker-info">
						<span class="ljs2018-template-schedule__time">01:30 - 03:05</span>
						<span class="ljs2018-template-schedule__name">Matt Morgis + Tamera Lanham</span>
						<span class="ljs2018-template-schedule__title">Pair Programming with TDD and Jest Workshop</span>
					</div>
					<div class="ljs2018-template-schedule__more-toggle">
						<i
							class="fa fa-chevron-up ljs2018-template-schedule__more-toggle-icon"
			...
			<div class="ljs2018-template-schedule__speaker ljs2018-template-schedule__speaker-two">
				<div class="ljs2018-template-schedule__speaker-body">
					<img
						...
						alt="William Lyon">
					<div class="ljs2018-template-schedule__speaker-info">
						<span class="ljs2018-template-schedule__time">01:30 - 02:10</span>
						<span class="ljs2018-template-schedule__name">William Lyon</span>
						<span class="ljs2018-template-schedule__title">Full Stack Graph Application Development Using the GRAND Stack: GraphQL, React, Apollo, and Neo4j Database</span>
					</div>
					<div class="ljs2018-template-schedule__more-toggle">
						<i
							class="fa fa-chevron-up ljs2018-template-schedule__more-toggle-icon"
			...
			<div class="ljs2018-template-schedule__speaker ljs2018-template-schedule__speaker-two">
				<div class="ljs2018-template-schedule__speaker-body">
					<img
						...
						alt="Matt Hayes">
					<div class="ljs2018-template-schedule__speaker-info">
						<span class="ljs2018-template-schedule__time">02:25 - 03:05</span>
						<span class="ljs2018-template-schedule__name">Matt Hayes</span>
						<span class="ljs2018-template-schedule__title">Particle Systems for Fun and Profit</span>
					</div>
					<div class="ljs2018-template-schedule__more-toggle">
						<i
							class="fa fa-chevron-up ljs2018-template-schedule__more-toggle-icon"
			...
			<div class="ljs2018-template-schedule__speaker ljs2018-template-schedule__speaker-one">
				<div class="ljs2018-template-schedule__speaker-body">
					<img
						...
						alt="Martin Snyder">
					<div class="ljs2018-template-schedule__speaker-info">
						<span class="ljs2018-template-schedule__time">03:20 - 4:55</span>
						<span class="ljs2018-template-schedule__name">Martin Snyder</span>
						<span class="ljs2018-template-schedule__title">Functional Programming in JavaScript Workshop</span>
					</div>
					<div class="ljs2018-template-schedule__more-toggle">
						<i
							class="fa fa-chevron-up ljs2018-template-schedule__more-toggle-icon"
			...
			<div class="ljs2018-template-schedule__speaker ljs2018-template-schedule__speaker-two">
				<div class="ljs2018-template-schedule__speaker-body">
					<img
						...
						alt="John + Chris">
					<div class="ljs2018-template-schedule__speaker-info">
						<span class="ljs2018-template-schedule__time">03:20 - 04:00</span>
						<span class="ljs2018-template-schedule__name">John Riviello + Chris Lorenzo</span>
						<span class="ljs2018-template-schedule__title">Web Components: The Future of Web Development is Here</span>
					</div>
					<div class="ljs2018-template-schedule__more-toggle">
						<i
							class="fa fa-chevron-up ljs2018-template-schedule__more-toggle-icon"
			...
			<div class="ljs2018-template-schedule__speaker ljs2018-template-schedule__speaker-two">
				<div class="ljs2018-template-schedule__speaker-body">
					<img
						...
						alt="Emily Freeman">
					<div class="ljs2018-template-schedule__speaker-info">
						<span class="ljs2018-template-schedule__time">04:15 - 4:55</span>
						<span class="ljs2018-template-schedule__name">Emily Freeman</span>
						<span class="ljs2018-template-schedule__title">The Dr. Seuss Guide to Code Craftsmanship</span>
					</div>
					<div class="ljs2018-template-schedule__more-toggle">
						<i
							class="fa fa-chevron-up ljs2018-template-schedule__more-toggle-icon"
	...
	<div class="ljs2018-template-schedule__container-day" id="ljs2018-template-schedule__day2">
		<div class="ljs2018-template-schedule__date">
			<p>NOV 17TH</p>
			<p><a href="#ljs2018-template-schedule__day1">DAY 1</a> / <span class="ljs2018-template-schedule__date-active">DAY 2</span></p>
		</div>
		<div class="ljs2018-template-schedule__speakers">
			<div class="ljs2018-template-schedule__speaker ljs2018-template-schedule__speaker-three">
				<div class="ljs2018-template-schedule__speaker-body">
					...
					<div class="ljs2018-template-schedule__speaker-info">
						<span class="ljs2018-template-schedule__time">09:30 - 10:10</span>
						<span class="ljs2018-template-schedule__name">Len Smith</span>
						<span class="ljs2018-template-schedule__title">An Introduction to Functional Programming in JavaScript</span>
					</div>
					<div class="ljs2018-template-schedule__more-toggle">
						<i
							class="fa fa-chevron-up ljs2018-template-schedule__more-toggle-icon"
			...
			<div class="ljs2018-template-schedule__speaker ljs2018-template-schedule__speaker-one">
				<div class="ljs2018-template-schedule__speaker-body">
					...
					<div class="ljs2018-template-schedule__speaker-info">
						<span class="ljs2018-template-schedule__time">10:25 - 12:00</span>
						<span class="ljs2018-template-schedule__name">Eric Lewis</span>
						<span class="ljs2018-template-schedule__title">Intro to React Workshop</span>
					</div>
					<div class="ljs2018-template-schedule__more-toggle">
						<i
							class="fa fa-chevron-up ljs2018-template-schedule__more-toggle-icon"
			...
			<div class="ljs2018-template-schedule__speaker ljs2018-template-schedule__speaker-two">
				<div class="ljs2018-template-schedule__speaker-body">
					...
					<div class="ljs2018-template-schedule__speaker-info">
						<span class="ljs2018-template-schedule__time">10:25 - 11:05</span>
						<span class="ljs2018-template-schedule__name">Kathryn Stracquatanio + Sarah Polansky</span>
						<span class="ljs2018-template-schedule__title">Please Touch: Creating Applications for Museums</span>
					</div>
					<div class="ljs2018-template-schedule__more-toggle">
						<i
							class="fa fa-chevron-up ljs2018-template-schedule__more-toggle-icon"
			...
			<div class="ljs2018-template-schedule__speaker ljs2018-template-schedule__speaker-two">
				<div class="ljs2018-template-schedule__speaker-body">
					...
					<div class="ljs2018-template-schedule__speaker-info">
						<span class="ljs2018-template-schedule__time">11:20 - 12:00</span>
						<span class="ljs2018-template-schedule__name">Michael Schoonmaker</span>
						<span class="ljs2018-template-schedule__title">JavaScriptural Exegesis</span>
					</div>
					<div class="ljs2018-template-schedule__more-toggle">
						<i
							class="fa fa-chevron-up ljs2018-template-schedule__more-toggle-icon"
			...
			<div class="ljs2018-template-schedule__speaker ljs2018-template-schedule__speaker-one">
				<div class="ljs2018-template-schedule__speaker-body">
					...
					<div class="ljs2018-template-schedule__speaker-info">
						<span class="ljs2018-template-schedule__time">01:30 - 03:05</span>
						<span class="ljs2018-template-schedule__name">Brian Douglas</span>
						<span class="ljs2018-template-schedule__title">Zero to Webpack Workshop</span>
					</div>
					<div class="ljs2018-template-schedule__more-toggle">
						<i
							class="fa fa-chevron-up ljs2018-template-schedule__more-toggle-icon"
			...
			<div class="ljs2018-template-schedule__speaker ljs2018-template-schedule__speaker-two">
				<div class="ljs2018-template-schedule__speaker-body">
					...
					<div class="ljs2018-template-schedule__speaker-info">
						<span class="ljs2018-template-schedule__time">01:30 - 02:10</span>
						<span class="ljs2018-template-schedule__name">Hao Luo</span>
						<span class="ljs2018-template-schedule__title">Understanding Async Await in Javascript</span>
					</div>
					<div class="ljs2018-template-schedule__more-toggle">
						<i
							class="fa fa-chevron-up ljs2018-template-schedule__more-toggle-icon"
			...
			<div class="ljs2018-template-schedule__speaker ljs2018-template-schedule__speaker-two">
				<div class="ljs2018-template-schedule__speaker-body">
					...
					<div class="ljs2018-template-schedule__speaker-info">
						<span class="ljs2018-template-schedule__time">02:25 - 03:05</span>
						<span class="ljs2018-template-schedule__name">Nate Abele</span>
						<span class="ljs2018-template-schedule__title">Un-dux Your Front-end</span>
					</div>
					<div class="ljs2018-template-schedule__more-toggle">
						<i
							class="fa fa-chevron-up ljs2018-template-schedule__more-toggle-icon"
			...
			<div class="ljs2018-template-schedule__speaker ljs2018-template-schedule__speaker-three">
				<div class="ljs2018-template-schedule__speaker-body">
					...
					<div class="ljs2018-template-schedule__speaker-info">
						<span class="ljs2018-template-schedule__time">03:20 - 04:00</span>
						<span class="ljs2018-template-schedule__name">Tierney Cyren</span>
						<span class="ljs2018-template-schedule__title">Building the Foundations of the Node.js Community</span>
					</div>
					<div class="ljs2018-template-schedule__more-toggle">
						<i
							class="fa fa-chevron-up ljs2018-template-schedule__more-toggle-icon"
			...
			<div class="ljs2018-template-schedule__keynote">
				<div class="ljs2018-template-schedule__speaker-body">
					<img
						src="<?php echo esc_url( get_stylesheet_directory_uri() . '/img/ljs2018-keynote-pam-selle.jpg' ); ?>"
						alt="Pam Selle">
					<div class="ljs2018-template-schedule__speaker-info">
						<span class="ljs2018-template-schedule__time">04:15 - 4:55 (KEYNOTE SPEAKER)</span>
						<span class="ljs2018-template-schedule__name">Pam Selle</span>
						<span class="ljs2018-template-schedule__title">The Serverless Revolution</span>
					</div>
					<div class="ljs2018-template-schedule__more-toggle">
						<i
							class="fa fa-chevron-up ljs2018-template-schedule__more-toggle-icon"
			...
			<div class="ljs2018-template-schedule__speaker ljs2018-template-schedule__speaker-three">
				<div class="ljs2018-template-schedule__speaker-body">
					<div class="ljs2018-template-schedule__speaker-info">
						<span class="ljs2018-template-schedule__time">05:00 - 07:00</span>
						<span class="ljs2018-template-schedule__name">
							Afterparty at
							<a
								class="ljs2018-template-schedule__link"
